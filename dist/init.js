...
function initSneedEnvironment(cfg, fs) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    templateFolder = (cfg === null || cfg === void 0 ? void 0 : cfg.templateFolder) || 'templates';
                    return [4 /*yield*/, fs.exists(templateFolder)];
                case 1:
                    if (!!(_a.sent())) return [3 /*break*/, 3];
                    return [4 /*yield*/, fs.createDir(templateFolder)];
                case 2:
                    _a.sent();
...
exports.initSneedEnvironment = initSneedEnvironment;
